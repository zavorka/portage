...
CARGO_SNAPSHOT_DATE="2017-12-07"
CRATES="
advapi32-sys-0.2.0
aho-corasick-0.5.3
aho-corasick-0.6.3
...
SRC_URI="https://github.com/rust-lang/cargo/archive/${PV}.tar.gz -> ${P}.tar.gz
	...
	amd64? ( https://static.rust-lang.org/dist/cargo-0.23.0-x86_64-unknown-linux-gnu.tar.gz )
"
RESTRICT="mirror"
...
src_compile() {
        ...
        local cargo="${WORKDIR}/cargo-0.23.0-x86_64-unknown-linux-gnu/cargo/bin/cargo"
        ${cargo} build --release
