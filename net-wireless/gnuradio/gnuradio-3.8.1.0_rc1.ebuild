...
inherit cmake-utils eutils gnome2-utils python-single-r1 versionator xdg-utils
...
IUSE="+audio +alsa atsc +analog +digital channels doc dtv examples fcd fec +filter jack log noaa oss pager performance-counters portaudio +qt5 sdl test trellis uhd vocoder +utils wavelet zeromq"
RESTRICT="!test? ( test )"
...
SRC_PV=$(get_version_component_range 1-4)
S=${WORKDIR}/${PN}-${SRC_PV}
