...
inherit cmake git-r3 plocale systemd user
...
PATCHES=(
	...
	"${FILESDIR}/${P}-Xsession.patch"
	"${FILESDIR}/${P}-sddmconfigdir.patch"
	# fix for groups: https://github.com/sddm/sddm/issues/1159
	"${FILESDIR}/${P}-Revert-Honor-PAM-s-ambient-supplemental-groups.-834.patch"
	"${FILESDIR}/${P}-Honor-PAM-s-supplemental-groups-v2-834-1159.patch"
	# TODO: fix properly
	"${FILESDIR}/${P}-ck2-revert.patch"
	"${FILESDIR}/${P}-pam-1.4-substack.patch"
)
