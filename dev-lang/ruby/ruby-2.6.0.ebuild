...
BUNDLED_GEMS="
	>=dev-ruby/did_you_mean-1.3.0[ruby_targets_ruby26]
...
src_prepare() {
	...
	rm -f gems/{did_you_mean-1.3.0,minitest-5.11.3,net-telnet-0.2.0,power_assert-1.1.3,rake-12.3.2,test-unit-3.2.9,xmlrpc-0.3.0}.gem || die
	rm -r gems/net-telnet-0.2.0 || die
